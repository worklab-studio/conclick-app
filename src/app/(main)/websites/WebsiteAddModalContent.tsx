  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setErrorMessage(
          'Tracking code not detected. Please ensure you have installed the code correctly on your website and try again.',
        );
      }
    } catch (e) {
        ...
        {isVerifying && (
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground text-center animate-pulse">
              Please wait while we check for the tracking code...
            </p>
          </div>
        )}
        ...
        <div className="flex justify-end pt-2">
          ...
          >
            {isVerifying ? (
              ...
              <>
                {errorMessage ? 'Try Again' : 'Verify Installation'}
