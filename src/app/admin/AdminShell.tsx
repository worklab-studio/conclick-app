...
import { Users, Globe, LayoutDashboard, Bell, LogOut } from 'lucide-react';
  ...
  return (
    <div className="flex min-h-screen bg-neutral-950 text-foreground font-sans">
      <aside className="w-64 border-r border-white/10 bg-neutral-900 flex flex-col fixed inset-y-0 left-0 z-[100] md:relative">
        <Link
          href="/admin"
          className="p-6 border-b border-white/10 flex items-center gap-2 hover:bg-white/5 transition-colors"
        >
        ...
        <div className="p-4 border-t border-white/10">
          <Button
            variant="ghost"
            className="w-full justify-start text-neutral-400 hover:text-white hover:bg-white/5 gap-3"
            asChild
          >
