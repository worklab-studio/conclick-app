...
const entry: ContentEntry = {
  ...
  "tldr": "Conclick is the top pick if you want to know which traffic actually earns money — it adds revenue attribution, heatmaps, and funnels that Fathom simply doesn't have. Plausible is the best pure pageview swap if you want near-identical simplicity at a lower price. Simple Analytics and Pirsch round out the field for specific use cases.",
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "Most heatmap tools (looking at you, Hotjar) reconstruct your page layout from the DOM and get it subtly wrong. Conclick takes an actual screenshot of your page and overlays clicks on top of it. You see rage clicks, dead clicks, and scroll depth on the real thing — not a approximation. If you've ever wondered why your pricing page isn't converting, this shows you in two minutes what a user research session would take two weeks to surface."
    },
    {
      "type": "h3",
    ...
    {
      "type": "p",
      "text": "Plausible is the tool most people should try first when leaving Fathom. The dashboards look almost identical. It's open-source, EU-hosted, cookieless, and the script is tiny. If all you need is clean pageview analytics and you want to pay less — Plausible starts at $9/month for up to 10k pageviews, which undercuts Fathom at the low end — this is your move."
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "The dashboard is less polished than Fathom or Plausible, and there's no revenue attribution or heatmaps. But if you're a developer-first team that wants full control and a clean API to build on top of, Pirsch punches above its weight. The cloud version starts at around $5/month."
    },
    {
      "type": "h2",
    ...
    },
    {
      ...
      "items": [
        ...
        "You're already using Fathom and it's working: stay. There's no reason to switch if it does what you need."
      ]
    },
    {
      "type": "p",
  ...
  "comparison": {
    ...
    "rows": [
      ...
      },
      {
        ...
        "conclick": true,
        "competitor": false,
        "note": "Conclick connects Stripe/Paddle/Polar/LemonSqueezy/Dodo to traffic; Fathom has no equivalent"
      },
      {
        "feature": "Real-screenshot heatmaps",
        "conclick": true,
        "competitor": false,
        "note": "Conclick overlays clicks on actual page screenshots; Fathom has no heatmap feature"
      },
      {
        "feature": "Auto-detected funnels",
        "conclick": true,
        "competitor": false,
        "note": "Conclick surfaces revenue drop-offs automatically; Fathom has no funnel analysis"
      },
      {
      ...
      },
      {
        ...
        "conclick": true,
        "competitor": true,
        "note": "Both are fully cookieless and privacy-first — this is a tie"
      },
      {
