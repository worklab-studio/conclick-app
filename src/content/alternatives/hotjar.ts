  ...
  "sections": [
    ...
    },
    {
      ...
      "items": [
        ...
        "Real-screenshot heatmaps: not DOM overlays — actual screenshots of your pages with click density, rage clicks, dead clicks, and scroll depth baked in",
        "Auto-detected funnels: Conclick finds where people drop off before converting, without you having to manually define each funnel step",
    ...
    {
      "type": "p",
      "text": "The trade-offs are real though. You are giving Microsoft your visitor data. There's no revenue attribution. The interface is decent but not exceptional. And because it's free, there's no particular urgency on Microsoft's side to improve it aggressively. It's a good diagnostic tool for a specific question: 'where are people clicking on this page?' It is not a revenue analytics platform."
    },
    {
      "type": "callout",
