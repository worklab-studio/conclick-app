...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "items": [
        ...
        "Cookieless by default, no consent banner needed in most jurisdictions, GDPR and CCPA compliant"
      ]
    },
    {
      "type": "p",
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Conclick uses real screenshots of your actual pages rather than synthetic overlays — the heatmap sits on top of exactly what visitors saw. It also includes rage click and dead click detection. Hotjar has more session recording depth but is not privacy-first, requires a cookie banner in many jurisdictions, and is significantly more expensive at scale."
    },
    {
  ...
  "comparison": {
    ...
    "rows": [
      ...
      },
      {
        ...
        "conclick": true,
        "competitor": true,
        "note": "Both offer 30-day trials; Conclick is 14 days"
      },
      {
        "feature": "Cookieless / no consent banner",
        "conclick": true,
        "competitor": true,
        "note": "Both are cookieless and GDPR-friendly by default"
      },
      {
        "feature": "Revenue attribution (Stripe / Paddle / etc.)",
        "conclick": true,
        "competitor": false,
        "note": "Conclick ties every payment back to traffic source and campaign; Plausible has no payment integrations"
      },
      {
        "feature": "Real-screenshot heatmaps and click maps",
        "conclick": true,
        "competitor": false,
        "note": "Conclick includes rage click, dead click, and scroll depth; Plausible has no heatmaps"
      },
      {
