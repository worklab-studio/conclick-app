...
const entry: ContentEntry = {
  ...
  "intro": "I've been self-hosting Umami for the better part of two years. It's fine. Cookieless, fast, open source. But somewhere around month six I realized I had a beautiful dashboard telling me my blog post got 3,400 pageviews—and absolutely no idea whether any of those visitors ever paid me anything. That's the gap Umami doesn't close. If all you need is \"how many people visited my site,\" Umami is perfectly adequate. But if you're a bootstrapped founder trying to figure out which ad, which SEO article, or which cold email sequence is actually generating revenue, you need something different. Here's an honest look at what's worth switching to in 2026.",
  "sections": [
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Conclick also auto-detects funnels. You don't have to manually define conversion paths—it surfaces the biggest drop-off points in your revenue funnel on its own. Combined with visual user journeys and a live global visitor map, you get a picture of your users that's genuinely useful for making product and marketing decisions, not just for impressing investors."
    },
    {
      "type": "ul",
      "items": [
        ...
        "Cookieless, GDPR/CCPA-friendly, usually no consent banner needed",
        "~2-minute setup",
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Conclick, Plausible, Fathom, Pirsch, and GoatCounter (hosted tier) are all fully managed—no server to run. Umami and GoatCounter are also self-hostable if you prefer to own your infrastructure. Conclick does not offer a self-hosted option."
    }
  ],
  "internalLinks": [],
  "relatedTools": [
    ...
    "rows": [
      {
        ...
        "conclick": true,
        "competitor": true,
        "note": "Both are cookieless and GDPR/CCPA-friendly"
      },
      {
      ...
      },
      {
        ...
        "conclick": true,
        "competitor": false,
        "note": "Conclick connects payments to traffic sources; Umami has no payment integrations"
      },
      {
