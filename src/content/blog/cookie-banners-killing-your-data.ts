...
const entry: ContentEntry = {
  ...
  "metaDescription": "Cookie consent banners block 40–60% of your visitors from ever being tracked. Here's what that does to your data and what to do about it.",
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "The hardest part of ditching cookies is revenue attribution — connecting a payment back to the traffic source that generated it. Most cookieless tools punt on this entirely and just show you page stats. That's not enough. You need to know whether that $299 subscription came from your ProductHunt launch or a random Google search. Without that connection, you're still guessing about ROI."
    },
    {
      "type": "p",
      "text": "This is the problem we built Conclick to solve specifically. It's cookieless analytics — so no banner, GDPR-friendly, ~2-minute setup — but it ties every Stripe, Paddle, Lemon Squeezy, or Dodo payment back to its traffic source, campaign, and funnel step. You see real revenue attribution, real-screenshot heatmaps, auto-detected funnels, and a daily digest in Slack or email. It's $9/month, 14-day free trial, no card required. Mentioning it here because it's exactly the product I wish I'd had before I realized how broken my own analytics were."
    },
    {
      "type": "h2",
    ...
    },
    {
      ...
      "items": [
        ...
        "Check how much traffic lands as 'direct' in your current tool. If it's more than 20 percent of total sessions, attribution is broken.",
