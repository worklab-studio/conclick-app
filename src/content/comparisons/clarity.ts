...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "This is the core reason I built Conclick. Connect your Stripe, Paddle, Polar, Lemon Squeezy, or Dodo account and every payment gets tied back to the UTM campaign, referral source, and funnel step that produced it. Not just 'this user converted' — the actual dollar amount, attributed to the traffic source."
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "Conclick generates real-screenshot heatmaps — actual renders of your page with click density overlaid, not a reconstructed approximation. Scroll depth, rage clicks, and dead clicks are all tracked. If you have been using Clarity specifically for its visual click data, you will not be giving that up."
    },
    {
      "type": "p",
      "text": "Visual user journeys show you the paths real visitors take through your site, not just individual page stats. Combined with the live global visitor map, you get a picture of who is on your site right now and where they came from — the kind of thing that is oddly motivating when you are shipping alone at 11pm."
    },
    {
      "type": "h2",
    ...
    },
    {
      "type": "ul",
      "items": [
        "Use Microsoft Clarity if: you have no paid product yet, you need session recordings at zero cost, or your primary need is pure UX research with no revenue to attribute.",
        ...
        "Use both if: you want Clarity's unlimited session recordings on top of Conclick's revenue and traffic layer — they are not mutually exclusive."
      ]
    }
  ],
  "faq": [
  ...
  "comparison": {
    ...
    "rows": [
      ...
      },
      {
        ...
        "conclick": true,
        "competitor": false,
        "note": "Clarity uses cookies by default"
      },
      {
