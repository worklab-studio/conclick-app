...
const entry: ContentEntry = {
  ...
  "sections": [
    {
      "type": "h2",
      "text": "What Both Tools Get Right",
      "id": "what-they-share"
    },
    {
      "type": "p",
    ...
    {
      "type": "h2",
      "text": "Where DataFast Is the Better Choice",
      "id": "where-datafast-wins"
    },
    {
      "type": "p",
    ...
    {
      "type": "h3",
      "text": "Auto-Detected Funnels With Revenue at Stake",
      "id": "funnels"
    },
    {
      "type": "p",
    ...
    {
      "type": "h3",
      "text": "Visual User Journeys and a Live Global Visitor Map",
      "id": "journeys-map"
    },
    {
      "type": "p",
    ...
    {
      "type": "h3",
      "text": "Daily Digest to Slack, Discord, or Telegram",
      "id": "daily-digest"
    },
    {
      "type": "p",
    ...
    {
      "type": "h2",
      "text": "Pricing Side by Side",
      "id": "pricing"
    },
    {
      "type": "p",
      "text": "Conclick starts at $9/month (or $7/month billed yearly). There is also a one-time lifetime deal for founders who prefer to buy once and own it. DataFast starts at $9/month for one site and goes to $19/month for their Growth tier with 30 sites. Both have a 14-day free trial with no credit card. If you are running a single product, the entry price is identical. The lifetime option on Conclick is worth looking at if you are early-stage and want to lock in costs."
    },
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Pick DataFast if: you are tracking a mobile app alongside your web product, you run active social campaigns on X or Reddit and need that attribution natively, or you manage 20+ sites and want them all under one $19/month plan."
    },
    {
      "type": "p",
  ...
  "faq": [
    {
      "question": "Does Conclick integrate with the same payment providers as DataFast?",
      "answer": "Mostly yes, with differences on the edges. Both support Stripe, Lemon Squeezy, and Polar. Conclick adds Paddle and Dodo Payments. DataFast adds Shopify. If you are on Paddle or Dodo, Conclick is your only option of the two. If you run a Shopify store and want native Shopify revenue attribution, DataFast has the edge there."
    },
    {
    ...
    },
    {
      ...
      "answer": "Both. Revenue attribution works for any Stripe, Paddle, Polar, Lemon Squeezy, or Dodo Payments transaction, which covers most SaaS billing and a large chunk of digital product ecommerce. Heatmaps and funnel drop-off analysis are particularly useful for product landing pages, checkout flows, and onboarding sequences regardless of whether you sell subscriptions or one-time purchases."
    },
    {
      "question": "How does Conclick's lifetime deal work?",
      "answer": "Instead of paying $9/month indefinitely, you can pay a one-time fee and own access permanently. This is a common option for bootstrapped founders who prefer to eliminate recurring costs on tooling. The lifetime deal is available directly on the Conclick pricing page. DataFast does not currently offer a lifetime option."
    },
    {
    ...
    "rows": [
      {
        ...
        "conclick": "5 payment providers",
        "competitor": "4 payment providers",
        "note": "Conclick adds Dodo and Paddle; DataFast adds Shopify"
      },
      {
        "feature": "Heatmaps & click maps",
        "conclick": true,
        "competitor": false,
        "note": "Real-screenshot overlay with rage/dead click detection"
      },
      {
        "feature": "Auto-detected funnels",
        "conclick": true,
        "competitor": "Manual setup",
        "note": "Conclick surfaces biggest drop-off + revenue lost automatically"
      },
      {
      ...
      {
        "feature": "Social mention tracking",
        "conclick": false,
        "competitor": "Growth plan only",
        "note": "DataFast monitors X and Reddit; Conclick does not"
      },
      {
        "feature": "Mobile SDK (iOS/Android)",
        "conclick": false,
        "competitor": true,
        "note": "DataFast has native mobile SDKs; Conclick is web-first"
      },
      {
        "feature": "Daily digest (Slack/Discord/Telegram)",
        "conclick": true,
        "competitor": false,
        "note": "AI-written narrative, not just a data email"
      },
      {
      ...
      },
      {
        ...
        "competitor": "$9/mo",
        "note": "Conclick has a lifetime deal option; DataFast does not"
      }
    ]
  }
};
