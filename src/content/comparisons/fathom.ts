...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "Conclick automatically surfaces your single biggest drop-off point in your [conversion funnel](/glossary/conversion-funnel) and quantifies the revenue you're losing to it. Not a list of funnel steps you have to configure manually. The one number that matters most, presented directly. If 60% of people leave at your pricing page, you find out in the dashboard, not six months later after you've shipped three other features."
    },
    {
      "type": "h3",
    ...
    },
    {
      "type": "ul",
      "items": [
        "Use Fathom if you want simple, private, fast pageview analytics and don't need to tie traffic to revenue: content sites, portfolios, documentation, agency client dashboards where conversion tracking isn't in scope.",
        ...
        "Use Conclick if you want to see where users are clicking, scrolling, and dropping off, and want that data tied to revenue rather than just counts.",
  ...
  "internalLinks": [
    {
      "href": "/alternatives/fathom",
      "label": "Fathom Analytics alternative",
      "group": "alternative"
    },
    {
