...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "Conclick captures real-screenshot heatmaps — clicks, scroll depth, rage clicks, and dead clicks — on the actual page your visitors see. No synthetic rendering, no approximation. You see where people are clicking on your real site, alongside the traffic and revenue data in the same dashboard."
    },
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Conclick auto-detects funnels from your actual traffic patterns. More importantly, it surfaces your single biggest drop-off and calculates the revenue you're losing to it — not just the conversion percentage, but the dollar amount. That framing changes how you prioritize fixes."
    },
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Mixpanel has a free plan up to 20M events/month. That sounds generous, and for early product exploration it is. But once you're tracking seriously, event volume adds up fast. Paid plans start at $28/mo and scale with data volume and user seats — real costs for real teams."
    },
    {
      "type": "p",
  ...
  "comparison": {
    ...
    "rows": [
      ...
      },
      {
        ...
        "conclick": true,
        "competitor": false,
        "note": "Conclick is cookieless by design. Mixpanel uses cookies and typically requires a consent banner under GDPR."
      },
      {
