...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "This is where the tools genuinely diverge. Conclick is cookieless by design. That means no consent banner in most jurisdictions, no GDPR headaches, no third-party cookies that browsers are increasingly blocking anyway. The tracking script is lightweight, so your page speed does not take a hit. You drop in one line of JavaScript and you are done."
    },
    {
      "type": "p",
    ...
    {
      "type": "callout",
      "text": "A consent banner that loads before your analytics fires means you are already missing data on the 30 to 60% of visitors who decline. [Cookieless tracking](/glossary/cookieless-analytics) is not just a compliance preference; it is a data completeness decision."
    },
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Both tools can track events. Neither automatically knows what those events are worth unless you wire up a payment source. Conclick connects directly to Stripe, Paddle, Polar, Lemon Squeezy, and Dodo. Once connected, every payment is traced back to the [original traffic source](/glossary/marketing-attribution), campaign UTM, and funnel step that preceded it. You can see that your SEO traffic converts at 3.2% and your Twitter traffic converts at 0.4%, in dollars, not just in clicks."
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "Conclick generates heatmaps from real screenshots of your pages. Clicks, scroll depth, rage clicks, and dead clicks are overlaid on an actual render of your site, not a reconstructed DOM approximation. Funnels are auto-detected. The dashboard surfaces your [single biggest drop-off point](/guides/how-to-read-a-funnel) and calculates the revenue lost to it. That last part matters: knowing you lose 68% of visitors between pricing and checkout is less useful than knowing that gap costs you an estimated $3,400/month."
    },
    {
      "type": "p",
  ...
  "internalLinks": [
    {
      "href": "/alternatives/posthog",
      "label": "Best PostHog alternatives",
      "group": "alternative"
    },
    {
      "href": "/vs/mixpanel",
