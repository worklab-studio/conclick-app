...
const entry: ContentEntry = {
  ...
  "metaDescription": "Both are cookieless and privacy-first. But Simple Analytics stops at pageviews. Conclick adds revenue attribution, heatmaps, and funnels. Here's the honest comparison.",
  "tldr": "Simple Analytics is a genuinely clean, privacy-first analytics tool — it does pageviews and referrers beautifully, and it is the right choice if that is all you need. Conclick is built for founders who need to tie traffic to actual revenue: it adds Stripe/Paddle/Polar/Lemon Squeezy/Dodo attribution, real-screenshot heatmaps, auto-detected funnels with revenue lost per drop-off, and a daily digest to Slack or email. If you are running a paid product and need to know which campaign made you money, Conclick gives you that answer directly.",
  "intro": "I built Conclick because I kept staring at a Simple Analytics dashboard that told me I had 1,200 visitors from Product Hunt and no idea whether any of them paid. The pageview graph looked great. My bank account was indifferent. Simple Analytics is honestly one of the better privacy-first tools out there — but it was built to answer \"how many people came,\" not \"which ones converted and how much did they spend.\" Those are different products solving different problems.",
  "sections": [
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Simple Analytics does not have revenue attribution. That is not a knock — it is a product decision. Their tool is deliberately minimal. But for a bootstrapped SaaS or ecommerce founder, \"minimal\" at the analytics layer can mean flying blind at the business layer."
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "Simple Analytics does not have heatmaps or funnels. Conclick does, and the implementation is worth describing specifically because it is different from most heatmap tools."
    },
    {
      "type": "p",
      "text": "The heatmaps use real screenshots of your actual pages — not a reconstructed DOM or an approximation. Clicks, scroll depth, rage clicks, and dead clicks all land on top of the actual page your users saw. This matters when your layout changes frequently, because you are always looking at the right screenshot for that period."
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "Conclick sends a daily summary to email, Slack, Discord, or Telegram. It calls out spikes, milestones, and anomalies in plain language rather than a data dump. Simple Analytics has no equivalent. This is a small feature but a meaningful one for solo founders who are not opening their dashboard every day — the digest brings the signal to you."
    },
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Simple Analytics has a cleaner, more polished single-page dashboard. If your team includes non-technical stakeholders who want to see traffic trends at a glance without any learning curve, Simple Analytics wins on pure UX simplicity. The dashboard is genuinely beautiful and fast."
    },
    {
      "type": "p",
      "text": "Simple Analytics is also the right call if you run a content site, blog, or any project with no payment layer. There is nothing for revenue attribution to connect to, so you would be paying for features you cannot use. For pure traffic intelligence on a free or ad-supported property, Simple Analytics does exactly what you need at a competitive price."
    },
    {
      "type": "p",
      "text": "If you specifically want a minimal tool with no extra features creeping in over time, Simple Analytics has been disciplined about scope. Conclick is adding more. That is a real trade-off: some founders want focused tools, not expanding ones."
    },
    {
      "type": "callout",
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "The base setup — paste a script tag, see traffic — takes about two minutes and is the same as Simple Analytics. Revenue attribution takes a few extra minutes to connect your payment processor via the settings panel. Heatmaps start recording immediately with no additional configuration."
    },
    {
      "question": "What if I run a content site with no payment processor? Which tool should I use?",
      "answer": "Simple Analytics is likely the better fit for a pure content site or blog. The revenue attribution and funnel features in Conclick require a payment layer to be meaningful. Paying for those features when you cannot use them does not make sense. Simple Analytics does traffic intelligence cleanly and at a fair price."
    },
    {
