...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "Most analytics work is top-of-funnel: pageviews, sessions, [bounce rate](/glossary/bounce-rate). Those numbers feel meaningful but they are rarely actionable. Funnel analysis is different because it is directly tied to revenue. If your pricing page converts at 4% and you can move it to 6%, that is a 50% increase in customers from the same traffic. No ad spend required."
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "Including steps that everyone always completes (like a loading screen) inflates your conversion numbers and hides real friction. Each step you include should represent a meaningful decision point: a moment where a user either commits to the next stage or leaves. If 98% of people who see a page move to the next one, that step is not worth including."
    },
    {
      "type": "h3",
    ...
    {
      "type": "p",
      "text": "Your overall conversion rate is an average across traffic sources, devices, and user types. Averages hide everything. Organic search traffic may convert at 3x the rate of paid social. Mobile may [drop off at checkout](/guides/where-users-abandon-checkout) at twice the rate of desktop. If you only look at blended numbers, you will never find those gaps. Break your funnel by source, by device, by plan tier, by geography: wherever segmentation is meaningful for your business."
    },
    {
      "type": "h2",
    ...
    },
    {
      ...
      "items": [
        ...
        "Ignoring the step right before the biggest drop-off. People fixate on [where users leave](/guides/how-to-read-a-funnel), but the more useful question is: what happened just before that? What did they see, click, or fail to find? That is where the fix usually lives.",
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Cookieless funnel tracking works by identifying users via first-party methods (a logged-in user ID, an email hash, or a server-side session identifier) rather than third-party cookies. For anonymous visitors, some tools use privacy-preserving fingerprinting or simply track aggregate completion rates without individual-level stitching. The trade-off is that cross-session attribution becomes harder for users who do not log in. For most SaaS products where users sign up before the meaningful steps happen, cookieless tracking works well. For top-of-funnel ecommerce, some accuracy is lost compared to cookie-based tracking."
    }
  ],
  "internalLinks": [
    {
      "href": "/guides/how-to-read-a-funnel",
      "label": "How to Read a Funnel Without Fooling Yourself",
      "group": "guide"
    },
    {
      "href": "/guides/where-users-abandon-checkout",
      "label": "Find Where Users Abandon Checkout",
      "group": "guide"
    },
    {
