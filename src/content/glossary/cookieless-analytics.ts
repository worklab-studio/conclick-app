...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "A cookie is a small text file a website stores in the visitor's browser. Traditional analytics tools such as Universal Analytics, early Adobe Analytics, and most ad pixels used a persistent [first-party cookie](/glossary/first-party-cookies), often named something like _ga, to recognize the same visitor across sessions, days, and even devices. That cookie had an expiry of up to two years, which is why Google Analytics could report \"returning visitors\" so reliably."
    },
    {
      "type": "p",
    ...
    {
      "type": "p",
      "text": "In most EU jurisdictions, cookieless analytics that does not store persistent identifiers and does not share data with third parties falls outside the scope of [consent requirements under GDPR](/glossary/gdpr-compliant-analytics). The UK ICO and most EU Data Protection Authorities have indicated that ephemeral, aggregated analytics without personal data storage does not require consent. The practical outcome: no banner needed for the analytics layer specifically."
    },
    {
      "type": "p",
  ...
  "internalLinks": [
    {
      "href": "/glossary/first-party-cookies",
      "label": "First-Party Cookies, Explained",
      "group": "glossary"
    },
    {
      "href": "/glossary/gdpr-compliant-analytics",
      "label": "What Makes Analytics GDPR-Compliant",
      "group": "glossary"
    },
    {
