...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "callout",
      "text": "The dirty secret of most analytics data: if your script is loaded from a third-party CDN and writes its cookie via JavaScript, Safari's ITP may be capping your visitor ID to 24 hours. Your \"returning visitor\" numbers could be wrong by 30-40% on Safari-heavy audiences. Check your browser breakdown before trusting those figures."
    },
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "Some tools sidestep this entirely by not using cookies at all, fingerprinting browsers with IP + user-agent hashing or using server-side session stitching instead. These approaches have their own accuracy tradeoffs, but they genuinely avoid the consent requirement in most jurisdictions."
    },
    {
      "type": "h2",
  ...
  "internalLinks": [
    {
      ...
      "label": "Cookieless Analytics: The Complete Guide",
      "group": "glossary"
    },
    {
      "href": "/glossary/gdpr-compliant-analytics",
      "label": "GDPR-Compliant Analytics, Defined",
      "group": "glossary"
    },
    {
