...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "Here is what [compliant, cookieless analytics](/guides/gdpr-analytics-checklist) actually looks like in technical terms:"
    },
    {
      "type": "ul",
      "items": [
  ...
  "internalLinks": [
    {
      ...
      "label": "GDPR Analytics Checklist for Founders",
      "group": "guide"
    },
    {
