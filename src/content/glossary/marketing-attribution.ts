  ...
  "sections": [
    ...
    },
    {
      ...
      "items": [
        ...
        "[Overcounting direct traffic](/guides/organic-traffic-showing-as-direct). 'Direct' is a catch-all for sessions with no recorded referrer: it includes people who typed your URL, but also broken UTM tags, email clients that strip referrers, and HTTPS-to-HTTP referrer loss. A very high direct share usually means a tracking problem, not a branding success.",
  ...
  "internalLinks": [
    {
      ...
      "label": "Revenue Attribution: The Money View",
      "group": "glossary"
    },
    {
      "href": "/glossary/utm",
      "label": "UTM Parameters, Demystified",
      "group": "glossary"
    },
    {
