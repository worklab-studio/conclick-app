...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "GA4 shifted from sessions as the core metric to events and users. It introduced engaged sessions — sessions that last more than 10 seconds, have a conversion event, or include at least two page views. This is more useful than raw session counts because a 3-second bounce no longer inflates your numbers the same way. GA4 also unified web and app sessions under the same model, which matters if you have both. If you are migrating from Universal Analytics, your session counts in GA4 will look lower, not because traffic dropped, but because the definition tightened."
    },
    {
      "type": "h2",
