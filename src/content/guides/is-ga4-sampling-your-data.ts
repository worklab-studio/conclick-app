...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "I built Conclick for exactly this use case. It stores all event data, never samples, and is designed around the question 'which traffic actually made money.' It connects directly to Stripe, Paddle, Polar, Lemon Squeezy, and Dodo Payments so you can tie every conversion back to the source, campaign, and funnel step that earned it. It also generates real-screenshot heatmaps and auto-detects your biggest funnel drop-off with the revenue estimate attached to fixing it. It is not a GA4 replacement for enterprise teams who need the full Google ecosystem. But for a founder who wants to know why conversions dropped last Tuesday and which channel is actually profitable, it is more useful than a sampled Exploration. $9/month, no card required for the trial, two-minute setup. If you want to compare it against the other tools founders move to when sampling becomes the last straw, I ranked them in [my roundup of GA4 alternatives](/alternatives/google-analytics)."
    },
    {
      "type": "h2",
