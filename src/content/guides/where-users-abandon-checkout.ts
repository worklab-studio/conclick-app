...
const entry: ContentEntry = {
  "type": "guide",
  "slug": "where-users-abandon-checkout",
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "There are three moves, in order. First, write your checkout out as a list of discrete steps, each one a page or an event you can count. Second, measure how many people enter and exit each step, then rank the gaps by the revenue they cost, not by the raw percentage. Third, take the single worst step and put a click map and a scroll map on it, so you stop guessing why people leave and start watching them leave. A funnel identifies which step is bleeding. A heatmap explains it. You need both, and you need them in that order."
    },
    {
      "type": "p",
      "text": "Most people skip straight to the heatmap because it is the fun part. Then they spend a week studying a page that was never the problem. Do the funnel math first. It is boring, and it is the whole game."
    },
    {
      "type": "h2",
      "text": "Step one: turn the checkout into countable steps",
      "id": "define-the-funnel"
    },
    {
      "type": "p",
      "text": "A checkout is not one thing that either works or does not. It is a chain, and every link is a place someone can fall out. Before you open any tool, write the chain on paper."
    },
    {
      "type": "p",
    ...
    {
      "type": "callout",
      "text": "If you can state the goal in one sentence and list every step between the visitor and that goal, you can build the funnel. If you cannot, that is the first thing to fix, and it is a product problem, not an analytics one."
    },
    {
      "type": "h2",
      "text": "Step two: find the biggest drop, measured in money",
      "id": "find-the-biggest-drop"
    },
    {
      "type": "p",
      "text": "Now you have entry and exit counts for each step. The drop-off rate at a step is entries minus exits, divided by entries. Calculate it for every step. You will get a column of percentages, and your instinct will be to attack the biggest one. Resist that."
    },
    {
      "type": "p",
      "text": "The step worth fixing is not the one with the highest percentage. It is the one where the percentage, multiplied by the traffic, multiplied by your average order value, destroys the most revenue. A ninety percent drop on a step three people reach is a rounding error. A thirty percent drop on the step everyone reaches is your rent."
    },
    {
      "type": "ol",
      "items": [
        "List every step with its entry count and exit count for the same date range.",
        "Compute the drop-off at each step: entries minus exits, divided by entries.",
        "Multiply the people lost at each step by your average revenue per order to get the money left on the table there.",
        "Rank the steps by that dollar figure, top to bottom.",
        "The top row is your only job. Ignore the rest until it is fixed."
      ]
    },
    {
      "type": "p",
      "text": "This ranking is the entire reason to build a funnel. It tells you which one screen to obsess over, and gives you permission to ignore the other nine. The long-standing finding in conversion work is that fixing the single biggest drop beats squeezing every step by a point. Concentrate."
    },
    {
      "type": "h2",
      "text": "Step three: put a heatmap on the worst step",
      "id": "heatmap-the-worst-step"
    },
    {
      "type": "p",
      "text": "The funnel has now handed you one step and one question: why do people leave here? A number cannot answer that. A picture of behavior can. This is where a click map and a scroll map earn their keep."
    },
    {
      "type": "p",
      "text": "Open the exact page the funnel flagged, and look at three things."
    },
    {
      "type": "ul",
      "items": [
    ...
    {
      "type": "p",
      "text": "The reason I built Conclick's maps over a real screenshot of the page rather than a reconstructed overlay is exactly this moment. When you are staring at the worst step in your funnel, you need the map to sit on the page as it actually rendered, so what you see is what your visitor saw. A drifting DOM approximation here is worse than useless, because it moves the evidence."
    },
    {
      "type": "h2",
      "text": "Match what you see to why people actually abandon",
      "id": "why-people-abandon"
    },
    {
      "type": "p",
      "text": "You do not have to guess at the possible reasons in a vacuum. The Baymard Institute has spent years asking people why they left, and the answers are consistent enough to use as a checklist while you read your heatmap."
    },
    {
      "type": "p",
      "text": "In their research on shoppers who abandoned checkout for a reason other than just browsing, the top causes were extra costs that were too high at 40 percent, delivery being too slow at 20 percent, not trusting the site with card details at 19 percent, being forced to create an account at 18 percent, and a checkout that was too long or complicated at 17 percent. Site errors and crashes tied that last one at 17 percent. The full list is in the sources below."
    },
    {
      "type": "p",
      "text": "Now map those to what a heatmap shows. If the abandonment is about surprise costs, your scroll map will often show people reaching the line where shipping and tax appear and stopping cold. If it is the forced account, watch the click activity cluster around the login or create-account area and then die. If it is a long form, the scroll and click pattern down a tall address block tells you which field people quit on. The survey data names the suspects. The heatmap tells you whether they are guilty on your page. Neither one alone is enough."
    },
    {
      "type": "callout",
      "text": "The point of the survey benchmarks is not to copy other people's fixes. It is to give you named suspects, so that when you read the heatmap on your worst step, you know which patterns are worth chasing."
    },
    {
      "type": "h2",
      "text": "A worked example, with numbers",
      "id": "worked-example"
    },
    {
      "type": "p",
      "text": "Say you sell a fifty dollar product. Here is one month of a four-step checkout."
    },
    {
      "type": "ul",
      "items": [
  ...
  "sources": [
    {
      "label": "Baymard Institute: Cart & Checkout Abandonment Rate Statistics",
      "url": "https://baymard.com/lists/cart-abandonment-rate"
    },
    {
      "label": "Baymard Institute: How to Reduce Cart Abandonment",
  ...
  "internalLinks": [
    ...
    },
    {
      ...
      "label": "How to read a funnel and fix the biggest leak",
      "group": "guide"
    },
    {
      "href": "/glossary/heatmap",
      "label": "How website heatmaps work",
      "group": "glossary"
    },
    {
      "href": "/for/ecommerce",
      "label": "Analytics for ecommerce stores",
      "group": "useCase"
    },
    {
      "href": "/vs/hotjar",
