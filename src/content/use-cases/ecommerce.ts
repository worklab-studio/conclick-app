...
const entry: ContentEntry = {
  ...
  "metaDescription": "Ecommerce analytics that connects traffic sources to real revenue, surfaces your biggest funnel drop-offs, and shows you exactly where customers leave. No cookies, 2-min setup.",
  "tldr": "Ecommerce stores need analytics that ties every visitor to a payment — not just pageviews. Most generic analytics tools show you traffic and bounce rate, but they can't tell you which ad campaign or blog post actually produced orders. Conclick connects your payment processor (Stripe, Paddle, Dodo, Lemon Squeezy, Polar) directly to traffic sources so you know exactly which channels earn revenue, not just clicks.",
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "That last one matters more than most people admit. A product page with a confusing layout — a button nobody can find, an image that loads below the fold, a price that requires scrolling — will silently kill conversions. You won't see it in a traffic report. You have to watch what people actually do on the page."
    },
    {
      "type": "ul",
      "items": [
    ...
    {
      "type": "p",
      "text": "Setup is a two-minute script install. Connect your payment processor via the integrations page. If you're already on GA4, import your historical data. You can have a working revenue attribution dashboard the same afternoon you sign up. There's no sampling, no data limits on the base plan, and the script is lightweight enough that it won't show up in your Core Web Vitals."
    },
    {
      "type": "p",
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Yes. Conclick supports team sharing and public dashboards. You can give team members access or generate a public link to a read-only dashboard view — useful for sharing monthly performance with investors or a co-founder without giving them full account access. The daily digest also goes to Slack, Discord, or Telegram if you prefer your metrics pushed to you rather than having to log in."
    }
  ],
  "internalLinks": [],
  "relatedTools": [],
