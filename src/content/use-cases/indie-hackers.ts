...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "callout",
      "text": "If your analytics tool can't tell you which traffic source generated the most revenue last month, you're not doing analytics — you're doing scorekeeping. Pageviews without payment context are a vanity metric in disguise."
    },
    {
      "type": "h2",
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "About two minutes for the core setup: copy a script tag into your site's head element. Works on Next.js, SvelteKit, plain HTML, WordPress, Webflow, Framer — any stack where you can edit the head. Connecting a payment processor is another five minutes in the integrations panel. There's no custom event schema to define, no data layer configuration, and no need to involve a developer once the script is in place."
    }
  ],
  "internalLinks": [],
  "relatedTools": [],
