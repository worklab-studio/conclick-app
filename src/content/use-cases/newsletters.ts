...
const entry: ContentEntry = {
  ...
  "sections": [
    ...
    {
      "type": "p",
      "text": "The challenge is attribution. A reader might find a free article through Google, subscribe to the free tier, sit on your list for three weeks, then buy the paid plan after clicking a link in issue 14. Generic analytics sees [a direct visit](/guides/organic-traffic-showing-as-direct) and a conversion. You need to see the whole chain."
    },
    {
      "type": "h2",
    ...
    {
      "type": "p",
      "text": "The third mistake is trusting [last-click attribution](/glossary/marketing-attribution). A reader finds you on Twitter, reads a free post, does not sign up, comes back a week later via a Google search for your name, and then subscribes. Last-click attribution gives all the credit to branded search. The Twitter post that started the chain gets nothing. You stop writing Twitter threads. That is a real cost."
    },
    {
      "type": "callout",
    ...
    {
      "type": "p",
      "text": "To be honest: Conclick does not have email-level analytics. It cannot tell you which specific issue of your newsletter drove a conversion; that requires [UTM parameters](/glossary/utm) in your email links and a deliberate tagging strategy on your end. If you want deep email sequence attribution (open rate, click rate, heatmaps inside the email), you need a dedicated email analytics tool for that layer. Conclick handles the web side of the funnel once someone lands on your site."
    },
    {
      "type": "p",
  ...
  "faq": [
    ...
    {
      "question": "Does Conclick work with Ghost or Substack?",
  ...
  "internalLinks": [
    ...
    },
    {
      ...
      "label": "Impressions up but clicks down",
      "group": "guide"
    },
    {
      "href": "/blog/why-revenue-attribution-matters",
      "label": "The case for revenue attribution",
      "group": "blog"
    }
  ],
  "relatedTools": [],
